...
import fr.damienraymond.servicejava.tp3.client.infrastructure.jaxrs.Outils;
import fr.damienraymond.servicejava.tp3.client.modele.BibliothequeArchive;
...
public class AppliCliente {
    ...
    public static Client clientJAXRS() {
        ...
        config.register(fr.damienraymond.servicejava.tp3.client.infrastructure.jaxb.FournisseurTraduction.class);
